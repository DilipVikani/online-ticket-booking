<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage1.master" AutoEventWireup="true" CodeFile="ysd_admin_bus_update.aspx.cs" Inherits="Admin_ysd_admin_bus_update" %>
                                ...
                                <thead>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                      ...
                                      <tr>  
                                            <td>Bus To </td>
                                             <td><asp:TextBox ID="bto" Text='<%#Eval("BusTo") %>' runat="server"></asp:TextBox> </td>
                                       </tr>
                                        <tr> 
                                            <td>Bus From </td>
                                            <td><asp:TextBox ID="bfrom" Text='<%#Eval("BusFrom") %>' runat="server"></asp:TextBox> </td>
                                        </tr>
                                        <tr>
                                            <td>Dep Time</td>
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td><asp:HyperLink runat="server" NavigateUrl="~/Admin/ysd_admin_busdetails.aspx" CssClass="btn btn-info" Text="Back" ></asp:HyperLink></td>
