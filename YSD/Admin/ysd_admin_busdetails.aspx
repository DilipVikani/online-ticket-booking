...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:Button runat="server" ID="btn1" CssClass=" btn-lg btn-danger"  Text="   ADD BUS    " OnClick="add_bus" />
    <br />
    <br />
    <br />
    <br />
                            ...
                            <table style="width:100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Bus To</th>
                                        <th class="auto-style6">Bus From</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><asp:Label ID="Label1" runat="server" Text='<%#Eval("BusTo") %>' ></asp:Label>
                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%#Eval("BusTO") %>' Visible="false"></asp:TextBox>
                                        </td>
                                        <td><asp:Label ID="Label2" runat="server" Text='<%#Eval("BusFrom") %>' ></asp:Label>
                                            <asp:TextBox ID="TextBox2" runat="server" Text='<%#Eval("BusFrom") %>' Visible="false"></asp:TextBox>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <asp:HyperLink runat="server" NavigateUrl='<%#Eval("id","ysd_admin_bus_moredetails.aspx?id={0}") %>' CssClass="btn btn-info" Text="More" />
                                            <asp:HyperLink runat="server" NavigateUrl='<%#Eval("id","ysd_admin_bus_update.aspx?id={0}") %>' CssClass="btn btn-info" Text="Edit" />
