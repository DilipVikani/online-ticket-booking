<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage1.master" AutoEventWireup="true" CodeFile="ysd_admin_flight_add.aspx.cs" Inherits="Admin_ysd_admin_flight_add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <h3 class=" top1"><u>FLIGHT</u></h3>
    ...
    <table class="w-100">
        <h6> Add Flight :- </h6>
        <tr>
            <td  class="auto-style5"><asp:TextBox ID="fto" runat="server" CssClass="form-control input-group-text" placeholder="Enter Flight To ."></asp:TextBox></td>
          </tr>
        <tr>
            <td class="auto-style6"><asp:TextBox ID="ffrom" runat="server" CssClass="form-control input-group-text" placeholder="Enter Flight From ."></asp:TextBox></td>
        </tr>
        <tr>
        ...
        <tr>
         ...
         NavigateUrl="~/Admin/ysd_admin_flight.aspx" Text="Back" ></asp:HyperLink></td>
           <td>&nbsp;</td>>
            <td>
                <asp:Button ID="Button1" runat="server" Text="Add Flight"
